                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="type" require class="form-control">
                                    ...
                                    <option value="photo" <?= $location['type'] == 'photo' ? 'selected' : '' ?>>Photo
                                    </option>
                                    <option value="hotel" <?= $location['type'] == 'hotel' ? 'selected' : '' ?>>Hotel
                                    </option>
                                    <option value="pump" <?= $location['type'] == 'pump' ? 'selected' : '' ?>>Gas
                                        station</option>
                                    <option value="food" <?= $location['type'] == 'food' ? 'selected' : '' ?>>Food
                                    </option>
                                    <option value="train" <?= $location['type'] == 'train' ? 'selected' : '' ?>>Train
                                    </option>
                                    <option value="museum" <?= $location['type'] == 'museum' ? 'selected' : '' ?>>Museum
                                    </option>
                                    <option value="market" <?= $location['type'] == 'market' ? 'selected' : '' ?>>Market
                                    </option>
                                    <option value="anchor" <?= $location['type'] == 'anchor' ? 'selected' : '' ?>>Anchor
                                    </option>
                                    <option value="cafe" <?= $location['type'] == 'cafe' ? 'selected' : '' ?>>Cafe
                                    </option>
